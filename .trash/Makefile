...
install :
	rm -rf /usr/local/include/libvm
	mkdir /usr/local/include/libvm
	cp  -rf ./include/* /usr/local/include/libvm
	cp  -rf ./lib/libcpp.so /usr/local/lib
uninstall : 
	rm -rf /usr/local/include/libvm
	rm -rf /usr/local/lib/libvm.so
